...
function App() {
  ...
  return (
    ...
    <div className="App">
     ...
     <input onChange={(e)=>setContraseña(e.target.value)}type='password' placeholder='New password' required=""></input>
     <input onChange={(e)=>setContraseña(e.target.value)}type='password' placeholder='Confirm password' required=""></input>
